...
exports.global = function(app){
  return function(req, res, next){
    ...
    // full url path
    res.locals.current_url = CONFIG.appenv.domain + req.url
    ...
    // customer url
    res.locals.c_url = function(url){
      //var url_lang = functions.get_url_lang(req.originalUrl)
      //return CONFIG.appenv.domain + '/site/' + req.session.u_id + '/' + url_lang + url
      return CONFIG.appenv.domain + '/site/' + req.session.u_id + url
    }
